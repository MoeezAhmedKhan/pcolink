            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Pco Cars First Section For Home</h4>
                                ...
                                <tbody>
                                    @foreach ($pcofirst as $home)
                                        <tr>
                                            ...
                                            <td><a href="pcofirstsection/{{ $home->id }}/edit"
                                                    class="badge bg-secondary">Edit</a></td>
                                            <td><a href="pcofirstsection/{{ $home->id }}/delete" class="badge bg-danger">Delete</a></td>
                                        </tr>
                                    @endforeach
