            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Manage Feature Section For PCO Cars Details</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="scroll-vertical"
                                ...
                                <tbody>
                                    @foreach ($pcocarsfeautre as $home)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $home->feature }}</td>
                                            <td><a href="{{ route('editpcocarfeatures', ['id'=>$home->id,'pcocarsid'=>$pcocarsid]) }}" class="badge bg-secondary">Edit</a></td>
                                            <td><a href="{{ route('deletepcocarfeatures', ['id'=>$home->id,'pcocarsid'=>$pcocarsid]) }}" class="badge bg-danger">Delete</a></td>
                                        </tr>
                                    @endforeach
