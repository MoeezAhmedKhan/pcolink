                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">View Insurance</li>
                            </ol>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($pcocarsinsurance as $home)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('editpcocarinsurance', ['id'=>$home->id,'pcocarsid'=>$pcocarsid]) }}" class="badge bg-secondary">Edit</a></td>
                                            <td><a href="{{ route('deletepcocarinsurance', ['id'=>$home->id,'pcocarsid'=>$pcocarsid]) }}" class="badge bg-danger">Delete</a></td>
                                        </tr>
                                    @endforeach
