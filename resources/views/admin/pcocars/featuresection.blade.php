        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/') }}/pcocarsfeaturesection" id="myForm" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(add_button).click(function(e) {
                ...
                if (x <= max_field) {
                    $(wrapper).append(
                        '<div class="col-md-10"><input type="text" name="features[]" required class="form-control" placeholder="Enter Features"></div><div class="col-md-2"><input type="button" class="btn btn-danger remove_field" value="Remove"></div>'
                    );
                    x++
                } else if (x > max_field) {
                    alert("You can't add textbox you can add 30 features only");
                }
            });
            $(wrapper).on("click", ".remove_field", function(e) {
                e.preventDefault();
                // $(this).find('input').parent('div').remove();
