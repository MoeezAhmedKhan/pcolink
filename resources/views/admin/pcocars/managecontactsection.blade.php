            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Manage Contact Section For PCO Cars Details</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table id="scroll-vertical"
                                ...
                                <tbody>
                                    @foreach ($pcocarsContact as $home)
                                        <tr>
                                            <td>{{ $loop->index + 1 }}</td>
                                            <td>{{ $home->text }}</td>
                                            <td>{{ $home->address }}</td>
                                            <td>{{ $home->number }}</td>
                                            <td><a href="pcocarscontactsection/{{ $home->id }}/edit"
                                                    class="badge bg-secondary">Edit</a></td>
                                            <td><a href="pcocarscontactsection/{{ $home->id }}/delete" class="badge bg-danger">Delete</a></td>
                                        </tr>
                                    @endforeach
