        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Benefit Section For Pco Cars Details</h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/') }}/pcocardetailsbenefitsection" id="myForm" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row gy-4 input_field_wrap">
                                    <div class="col-md-10">
                                        ...
                                        <input type="text" name="benefit[]" required class="form-control"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(add_button).click(function(e) {
                ...
                if (x <= max_field) {
                    $(wrapper).append(
                        '<div class="col-md-10"><input type="text" name="benefit[]" required class="form-control" placeholder="Enter Benefit"></div><div class="col-md-2"><input type="button" class="btn btn-danger remove_field" value="Remove"></div>'
                    );
                    x++
                } else if (x > max_field) {
                    alert("You can't add textbox you can add 30 benefit only");
                }
            });
