            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Manage Fifth Section For Home</h4>
                                ...
                                <tbody>
                                    @foreach ($homefifth as $home)
                                        <tr>
                                            ...
                                            <td><a href="homefifthsection/{{ $home->id }}/edit"
                                                    class="badge bg-secondary">Edit</a></td>
                                            <td><a href="homefifthsection/{{ $home->id }}/delete" class="badge bg-danger">Delete</a></td>
                                        </tr>
                                    @endforeach
