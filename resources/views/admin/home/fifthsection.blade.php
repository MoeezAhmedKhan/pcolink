        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Fifth Section For Home</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ url('/') }}/dashboard">Dashboard</a></li>
                                <li class="breadcrumb-item active">Add Home</li>
                                <li class="breadcrumb-item active">Fifth Section</li>
                            </ol>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url('/') }}/homefifthsection" method="post"
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleFormControlTextarea5" class="form-label">Section Short
                                            Description 1</label>
                                        <input type="text" name="description1" class="form-control" placeholder="Enter Short Description"
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleFormControlTextarea5" class="form-label">Section Short
                                            Description 2</label>
                                        <input type="text" name="description2" class="form-control" placeholder="Enter Short Description"
                                            value="{{ old('description2') }}">
                                    ...
                                    <div class="col-md-6">
                                        <label for="exampleFormControlTextarea5" class="form-label">Section Short
                                            Description 3</label>
                                        <input type="text" name="description3" class="form-control" placeholder="Enter Short Description"
                                            value="{{ old('description3') }}">
