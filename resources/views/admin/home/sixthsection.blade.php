    ...
    <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Sixth Section For Home</h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('/') }}/homesixthsection" method="post"
                            ...
                            <div class="row gy-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="left_text" class="form-control"
                                        placeholder="Enter Left Title" value="{{old('left_text')}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="left_button_text" class="form-control"
                                        placeholder="Enter Left Title" value="{{old('left_button_text')}}">
